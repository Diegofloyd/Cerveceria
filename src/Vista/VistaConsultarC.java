 ...
 * @author Johan López
 */
public class VistaConsultarC extends javax.swing.JFrame {

    /**
     * Creates new form VistaConsultarC
     */
    public VistaConsultarC() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaConsultarC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaConsultarC().setVisible(true);
            }
        });
    }
